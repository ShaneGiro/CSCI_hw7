...
/**
 * @brief Provides the definition for size_t.
 */
#include <stddef.h>
/**
 * @brief Provides uint64_t and uint8_t.
 */
#include <stdint.h>

/**
 * @brief Opaque data type for the KStream object.
 */
 ...
 *
 * Initializes the internal S array (0–255), performs the key-scheduling
 ...
 * ks_destroy().
 *
 * @param keybytes  An eight-byte array containing the binary key.
 *
...
/**
 * @brief End of the KSTREAM_H include guard.
 */
#endif
